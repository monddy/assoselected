        ...
        handler.prototype={
            ...
            match:function(quickExpr,value,source){
                ...
                if (jQuery.browser.msie && (jQuery.browser.version == "6.0") && !jQuery.support.style) {
					var wrapWidth = this.$popup.width();
					var wrapHeight = this.$popup.height();
					this.$popup.append('<iframe src="javascript:false" scrolling="no" style="position:absolute;width:'+(wrapWidth-18)+'px;height:'+(wrapHeight-25)+'px;padding:15px 0;left:0; top:0;filter:alpha(opacity=0);opacity=0;border-style:none;z-index:-1"></iframe>');
				}
